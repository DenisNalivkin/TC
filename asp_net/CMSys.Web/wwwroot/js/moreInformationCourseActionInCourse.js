var allButtons = document.querySelectorAll('.ButtonMoreInformationCourse');
...
allButtons.forEach(item => {
    item.addEventListener('click', e => { 
        ...
        document.querySelectorAll('.containerForCourses').forEach(e => e.remove());
        ...
        request.onreadystatechange = function() 
        {
            ...
            { 
                containerForCourses = document.querySelector(".divWithData2");
                dataCourses = JSON.parse(request.response);
                const amountCourses = Object.keys(dataCourses);

                containerForCourses = document.querySelector(".divWithData2");       
                newElem = document.createElement("div");
                newElem.setAttribute("class", "itemsContainerForCoursesActionInCourseList","id", "itemsContainerForCoursesActionInCourseListId");
                ...
                newElem.insertAdjacentHTML('afterbegin', `           
                    ...
                    <div class="divInformationCourseActionInCourseList">                      
                    <div class="containerAllTrainersInMoreInforamtionActionInCourseList" id="containerAllTrainersInMoreInforamtionActionInCourseListId">
                        <div class="itemsContainerAllTrainersInMoreInforamtion">  <p class="pStringCourseDescription">   Trainers: </p> </div>                       
                    </div>                                   
                    </div>                
                    <a class="aBackToListActionInCourseList" href="http://localhost:61558/CourseList/ShowActionInCourseList"> Back to list</a> 
                ...
                newElem = document.getElementById('containerAllTrainersInMoreInforamtionActionInCourseListId');   
